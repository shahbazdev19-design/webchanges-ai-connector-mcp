...
add_action('wp_abilities_api_categories_init', static function () {
    if (function_exists('wp_register_ability_category')) {
        wp_register_ability_category('webchanges-skills', [
            'label' => __('Skills', 'webchanges-ai-connector-mcp'),
            'description' => __('Reusable specialist playbooks (bundled + custom) the agent loads on demand; some carry runnable macros.', 'webchanges-ai-connector-mcp'),
        ]);
    }
});
