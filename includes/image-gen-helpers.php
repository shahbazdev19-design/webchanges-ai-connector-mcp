...
function webchanges_image_gen_providers(): array
{
    return [
        'openai' => [
            'label' => __('OpenAI', 'webchanges-ai-connector-mcp'),
        ...
        'gemini' => [
            'label' => __('Google Gemini (Nano Banana / Imagen)', 'webchanges-ai-connector-mcp'),
        ...
        'replicate' => [
            'label' => __('Replicate (Flux / SDXL / Recraft)', 'webchanges-ai-connector-mcp'),
        ...
        'pollinations' => [
            'label' => __('Pollinations (free — no API key)', 'webchanges-ai-connector-mcp'),
