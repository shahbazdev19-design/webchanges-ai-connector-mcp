...
function webchanges_connector_forms_formidable_set_email_action(int $form_id, array $spec, string $title = ''): int
{
    ...
    $settings = [
        ...
        'email_subject' => (string) ($spec['subject'] ?? sprintf(__('New %s submission', 'webchanges-ai-connector-mcp'), $title)),
    ...
    $post = [
        ...
        'post_status' => 'publish',
        'post_title' => (string) ($spec['name'] ?? __('Email Notification', 'webchanges-ai-connector-mcp')),
        'post_excerpt' => 'email',
        'menu_order' => $form_id,
...
function webchanges_connector_forms_formidable_create(string $title, array $fields, string $notify, array $settings = [], array $notifications = []): array
{
    ...
    $form_id = \FrmForm::create([
        ...
        'status' => 'published',
        'options' => [
            'submit_value' => __('Submit', 'webchanges-ai-connector-mcp'),
            'success_action' => 'message',
            'success_msg' => __('Thanks! Your submission has been received.', 'webchanges-ai-connector-mcp'),
        ],
    ]);
