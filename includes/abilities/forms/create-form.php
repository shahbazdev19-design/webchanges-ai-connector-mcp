...
webchanges_connector_register_ability('forms-create-form', [
    'label' => __('Create Form', 'webchanges-ai-connector-mcp'),
    'description' => __(
        ...
        if ($provider === 'wpforms') {
            ...
            $data = [
                ...
                'settings' => [
                    'form_title' => $title,
                    'form_desc' => '',
                    'submit_text' => __('Submit', 'webchanges-ai-connector-mcp'),
                    'submit_text_processing' => __('Sending...', 'webchanges-ai-connector-mcp'),
                    'notifications' => [
                        '1' => [
                            'notification_name' => __('Default Notification', 'webchanges-ai-connector-mcp'),
                            'email' => $notify,
                            /* translators: %s is the form title */
                            'subject' => sprintf(__('New entry: %s', 'webchanges-ai-connector-mcp'), $title),
