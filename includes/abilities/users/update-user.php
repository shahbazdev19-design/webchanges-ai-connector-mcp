...
webchanges_connector_register_ability('user-update', [
    'label' => __('Update User', 'webchanges-ai-connector-mcp'),
    'description' => __('Partial update of a user. Only fields you pass are touched. Pass `add_role` to add a secondary role; `set_role` to replace; `remove_role` to drop one.', 'webchanges-ai-connector-mcp'),
