...
webchanges_connector_register_ability('user-list', [
    'label' => __('List Users', 'webchanges-ai-connector-mcp'),
    'description' => __('Query WordPress users with WP_User_Query semantics. Returns slim rows: id, login, email, display_name, roles, registered date.', 'webchanges-ai-connector-mcp'),
