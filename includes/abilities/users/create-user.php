...
webchanges_connector_register_ability('user-create', [
    'label' => __('Create User', 'webchanges-ai-connector-mcp'),
    'description' => __('Create a WordPress user. A random password is generated unless one is supplied. Pass `send_email: true` to fire wp_send_new_user_notifications().', 'webchanges-ai-connector-mcp'),
