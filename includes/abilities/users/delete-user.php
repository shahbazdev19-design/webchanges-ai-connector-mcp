...
webchanges_connector_register_ability('user-delete', [
    'label' => __('Delete User', 'webchanges-ai-connector-mcp'),
    'description' => __('Delete a user. By default the user\'s content is also deleted; pass `reassign_to` (another user id) to keep the content and transfer ownership. Refuses to delete the connection user.', 'webchanges-ai-connector-mcp'),
