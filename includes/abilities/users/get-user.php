...
webchanges_connector_register_ability('user-get', [
    'label' => __('Get User', 'webchanges-ai-connector-mcp'),
    'description' => __('Full user record: core fields + roles + capabilities + meta + post counts per type.', 'webchanges-ai-connector-mcp'),
