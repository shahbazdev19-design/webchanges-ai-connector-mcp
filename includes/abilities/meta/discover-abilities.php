...
webchanges_connector_register_ability('discover-abilities', [
    'label' => __('Discover Webchanges Abilities', 'webchanges-ai-connector-mcp'),
    'description' => __(
    ...
    'execute_callback' => static function (array $input): array {
        ...
        $instructions = implode("\n", [
            ...
            '## Workflow rules',
            '',
            '1. **Discover first.** Before doing anything novel, scan the `abilities` list returned by this call to learn what is available, and prefer a purpose-built ability for the task.',
