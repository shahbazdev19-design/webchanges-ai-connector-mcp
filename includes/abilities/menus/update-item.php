...
webchanges_connector_register_ability('menu-update-item', [
    'label' => __('Update Menu Item', 'webchanges-ai-connector-mcp'),
    'description' => __('Partial update of one nav menu item. Only fields you pass are touched.', 'webchanges-ai-connector-mcp'),
