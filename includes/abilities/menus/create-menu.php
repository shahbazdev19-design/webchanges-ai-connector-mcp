...
webchanges_connector_register_ability('menu-create', [
    'label' => __('Create Nav Menu', 'webchanges-ai-connector-mcp'),
    'description' => __('Create a new empty nav menu. Optionally assign it to one or more theme locations in the same call.', 'webchanges-ai-connector-mcp'),
