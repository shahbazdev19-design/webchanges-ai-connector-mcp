...
webchanges_connector_register_ability('menu-list', [
    'label' => __('List Nav Menus', 'webchanges-ai-connector-mcp'),
    'description' => __('List all registered nav menus. Each menu includes its term id, name, slug, theme location assignments, and item count. Pass `include_items: true` to also return the flat item list per menu.', 'webchanges-ai-connector-mcp'),
