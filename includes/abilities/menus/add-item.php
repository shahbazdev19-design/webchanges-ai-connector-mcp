...
webchanges_connector_register_ability('menu-add-item', [
    'label' => __('Add Menu Item', 'webchanges-ai-connector-mcp'),
    'description' => __('Add a nav menu item. `type` is "custom" (free URL), "post_type" (link to a post/page/CPT), or "taxonomy" (link to a term). For non-custom types, pass `object_id` and `object` (post type slug or taxonomy slug).', 'webchanges-ai-connector-mcp'),
