...
webchanges_connector_register_ability('theme-list', [
    'label' => __('List Themes', 'webchanges-ai-connector-mcp'),
    'description' => __('List every theme installed. Identifies the active theme, parent themes, and child themes.', 'webchanges-ai-connector-mcp'),
