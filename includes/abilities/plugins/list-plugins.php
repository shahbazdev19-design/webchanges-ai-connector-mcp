...
webchanges_connector_register_ability('plugin-list', [
    'label' => __('List Plugins', 'webchanges-ai-connector-mcp'),
    'description' => __('List every plugin installed on this site. Each row includes slug, name, version, active flag, network-active flag, description, author, and required-PHP/required-WP.', 'webchanges-ai-connector-mcp'),
