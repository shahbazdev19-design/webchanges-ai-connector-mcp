...
webchanges_connector_register_ability('plugin-deactivate', [
    'label' => __('Deactivate Plugin', 'webchanges-ai-connector-mcp'),
    'description' => __('Deactivate one plugin by its slug. Refuses to deactivate Webchanges Connector itself — that would terminate this connection.', 'webchanges-ai-connector-mcp'),
    ...
    'execute_callback' => static function (array $input): array {
        ...
        if (str_contains($slug, 'webchanges-ai-connector-mcp')) {
