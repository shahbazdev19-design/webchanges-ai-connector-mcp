...
webchanges_connector_register_ability('theme-activate', [
    'label' => __('Activate Theme', 'webchanges-ai-connector-mcp'),
    'description' => __('Switch the active theme. Pass `stylesheet` (the theme folder slug). Verifies the theme exists before switching. Switching themes can break page builders — preview on a staging site first.', 'webchanges-ai-connector-mcp'),
