...
webchanges_connector_register_ability('tax-list-taxonomies', [
    'label' => __('List Taxonomies', 'webchanges-ai-connector-mcp'),
    'description' => __('List every taxonomy registered on this site, with its label, post types it applies to, hierarchical flag, and whether it is public.', 'webchanges-ai-connector-mcp'),
