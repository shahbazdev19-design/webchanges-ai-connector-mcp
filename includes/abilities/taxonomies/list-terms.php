...
webchanges_connector_register_ability('tax-list-terms', [
    'label' => __('List Terms', 'webchanges-ai-connector-mcp'),
    'description' => __('List terms in a taxonomy. Supports search, parent filter, hide_empty, orderby, per_page, page.', 'webchanges-ai-connector-mcp'),
