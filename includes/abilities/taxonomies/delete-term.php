...
webchanges_connector_register_ability('tax-delete-term', [
    'label' => __('Delete Term', 'webchanges-ai-connector-mcp'),
    'description' => __('Delete a term. Posts retain their other terms; the deleted term is removed from all assigned posts.', 'webchanges-ai-connector-mcp'),
