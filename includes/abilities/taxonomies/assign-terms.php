...
webchanges_connector_register_ability('tax-assign-terms', [
    'label' => __('Assign Terms to Post', 'webchanges-ai-connector-mcp'),
    'description' => __('Assign terms to a post. By default REPLACES the post\'s terms in that taxonomy; pass `append: true` to add without removing existing terms. Terms can be passed as ids, slugs, or names.', 'webchanges-ai-connector-mcp'),
