...
webchanges_connector_register_ability('image-list-providers', [
    'label' => __('List Image Generation Providers', 'webchanges-ai-connector-mcp'),
    'description' => __('Return supported image-gen providers, their models, sizes, and whether each is configured (has an API key saved).', 'webchanges-ai-connector-mcp'),
