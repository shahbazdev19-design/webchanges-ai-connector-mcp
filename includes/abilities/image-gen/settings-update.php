...
webchanges_connector_register_ability('image-settings-update', [
    'label' => __('Update Image Generation Settings', 'webchanges-ai-connector-mcp'),
    'description' => __('Set or clear image-gen settings. Only fields you pass are touched. Pass an empty string for any *_api_key to clear that provider.', 'webchanges-ai-connector-mcp'),
