...
webchanges_connector_register_ability('image-settings-get', [
    'label' => __('Get Image Generation Settings', 'webchanges-ai-connector-mcp'),
    'description' => __('Return the current image-gen configuration. API keys are masked — only their first 4 / last 4 chars are returned. Use `image-settings-update` to change values.', 'webchanges-ai-connector-mcp'),
