...
webchanges_connector_register_ability('site-update', [
    'label' => __('Update Site Identity', 'webchanges-ai-connector-mcp'),
    'description' => __('Partial update of core site identity options. Only fields you pass are touched. To set the site icon, pass `site_icon_id` (an attachment id, or 0 to clear).', 'webchanges-ai-connector-mcp'),
