...
webchanges_connector_register_ability('site-get', [
    'label' => __('Get Site Identity', 'webchanges-ai-connector-mcp'),
    'description' => __('Return core site identity: title, tagline, site icon (favicon), admin email, timezone, locale, date/time formats, default category, default post format, comment defaults, search engine visibility.', 'webchanges-ai-connector-mcp'),
