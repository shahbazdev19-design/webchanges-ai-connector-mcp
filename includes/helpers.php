...
function webchanges_connector_categories(): array
{
    return [
        'webchanges-meta' => [
            'label' => __('Webchanges Meta', 'webchanges-ai-connector-mcp'),
            'description' => __('Introspection and instructions.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-filesystem' => [
            'label' => __('Filesystem', 'webchanges-ai-connector-mcp'),
            'description' => __('Server filesystem operations.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-code' => [
            'label' => __('Code Execution', 'webchanges-ai-connector-mcp'),
            'description' => __('Abilities that execute code on the WordPress server.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-posts' => [
            'label' => __('Posts & Pages', 'webchanges-ai-connector-mcp'),
            'description' => __('Create, read, update, delete any post type.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-blocks' => [
            'label' => __('Block Editor', 'webchanges-ai-connector-mcp'),
            'description' => __('Structured edits against Gutenberg block trees.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-bricks' => [
            'label' => __('Bricks Builder', 'webchanges-ai-connector-mcp'),
            'description' => __('Read and write Bricks pages, headers, footers, and templates.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-elementor' => [
            'label' => __('Elementor', 'webchanges-ai-connector-mcp'),
            'description' => __('Read and write Elementor pages, sections, containers, and widgets.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-forms' => [
            'label' => __('Forms', 'webchanges-ai-connector-mcp'),
            'description' => __('Detect, list, create, and read submissions across WPForms, Gravity Forms, Formidable, Forminator, Fluent Forms, CF7, and Ninja Forms.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-media' => [
            'label' => __('Media Library', 'webchanges-ai-connector-mcp'),
            'description' => __('Upload, update, delete media; manage alt text and sizes.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-image-gen' => [
            'label' => __('AI Image Generation', 'webchanges-ai-connector-mcp'),
            'description' => __('Generate, edit, and replace images via OpenAI, Google Gemini (Nano Banana), or Replicate.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-stock' => [
            'label' => __('Stock Photos', 'webchanges-ai-connector-mcp'),
            'description' => __('Search and import from Pexels, Unsplash, and Pixabay. Used as auto-fallback when no AI image provider is configured.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-seo' => [
            'label' => __('SEO', 'webchanges-ai-connector-mcp'),
            'description' => __('RankMath / Yoast / SEOPress abilities for meta, schema, redirects.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-permalinks' => [
            'label' => __('Permalinks', 'webchanges-ai-connector-mcp'),
            'description' => __('Permalink structure, per-post slugs, slug-change redirects.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-taxonomies' => [
            'label' => __('Taxonomies', 'webchanges-ai-connector-mcp'),
            'description' => __('Categories, tags, custom taxonomies, terms, term hierarchy.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-menus' => [
            'label' => __('Menus', 'webchanges-ai-connector-mcp'),
            'description' => __('Nav menus and menu items.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-customizer' => [
            'label' => __('Customizer & Site Identity', 'webchanges-ai-connector-mcp'),
            'description' => __('Theme customizer, widgets, site title/tagline/icon, timezone, language.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-users' => [
            'label' => __('Users & Roles', 'webchanges-ai-connector-mcp'),
            'description' => __('User accounts, roles, capabilities.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-woocommerce' => [
            'label' => __('WooCommerce', 'webchanges-ai-connector-mcp'),
            'description' => __('Products, variations, orders, coupons.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-acf' => [
            'label' => __('ACF', 'webchanges-ai-connector-mcp'),
            'description' => __('Advanced Custom Fields groups and values.', 'webchanges-ai-connector-mcp'),
        ],
        'webchanges-plugins-themes' => [
            'label' => __('Plugins & Themes', 'webchanges-ai-connector-mcp'),
            'description' => __('List, activate, deactivate, install, update plugins and themes.', 'webchanges-ai-connector-mcp'),
        ],
    ];
}
...
{
    // This edition ships no arbitrary-code / filesystem-write abilities, so the
    // high-risk opt-in set is empty.
    return [];
}
