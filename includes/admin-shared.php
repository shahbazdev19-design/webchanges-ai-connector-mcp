...
function webchanges_connector_admin_header(string $active = ''): string
{
    ...
    $skills = admin_url('admin.php?page=webchanges-ai-connector-mcp-skills');
    $abilities = admin_url('admin.php?page=webchanges-ai-connector-mcp-abilities');
    $images = admin_url('admin.php?page=webchanges-ai-connector-mcp-images');
    ...
    <div class="wc-header">
        <a class="wc-brand" href="<?php echo esc_url($main); ?>" style="text-decoration:none;color:inherit;">
            ...
            <div>
                <div class="wc-brand-title"><?php esc_html_e('Webchanges', 'webchanges-ai-connector-mcp'); ?></div>
                <div class="wc-brand-sub"><?php echo esc_html((string) get_bloginfo('name')); ?></div>
            </div>
        </a>
        <div class="wc-header-right">
            <nav class="wc-nav">
                <a href="<?php echo esc_url($skills); ?>"<?php echo $active === 'skills' ? ' class="active"' : ''; ?>><?php esc_html_e('Skills', 'webchanges-ai-connector-mcp'); ?></a>
                <a href="<?php echo esc_url($images); ?>"<?php echo $active === 'images' ? ' class="active"' : ''; ?>><?php esc_html_e('Images', 'webchanges-ai-connector-mcp'); ?></a>
                <a href="<?php echo esc_url($abilities); ?>"<?php echo $active === 'abilities' ? ' class="active"' : ''; ?>><?php esc_html_e('Abilities', 'webchanges-ai-connector-mcp'); ?></a>
