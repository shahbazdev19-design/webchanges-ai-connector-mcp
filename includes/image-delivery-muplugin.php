...
<?php
/**
 * __HDR_NAME__: Webchanges Image Delivery
...
PHP;
    // '__HDR_NAME__' is substituted rather than written literally: get_file_data()
    // regexes raw bytes and does not parse PHP, so a literal "Plugin Name:" here
    // would make get_plugins('/<slug>') treat THIS file as a second plugin.
    return str_replace(['__HDR_NAME__', '__VER__'], ['Plugin Name', (string) $version], $body);
}
