...
/**
 * Plugin Name: Webchanges – AI Connector (MCP)
 * Plugin URI: https://shahbazdev.com/
 * Description: Connect WordPress to any MCP-compatible AI client so agents can manage content, blocks, media, SEO, forms, taxonomies, menus, users, WooCommerce, ACF, and site settings over the Model Context Protocol.
 * Version: 1.0.0
...
define('WEBCHANGES_CONNECTOR_VERSION', '1.0.0');
...
add_action('admin_menu', static function () {
    add_menu_page(
        __('Webchanges', 'webchanges-ai-connector-mcp'),
        'Webchanges',
        'manage_options',
...
add_action('mcp_adapter_init', static function ($adapter) {
    ...
    $adapter->create_server(
        ...
        'mcp',
        'Webchanges – AI Connector (MCP)',
        'Webchanges MCP endpoint. Exposes posts, blocks, media, SEO, forms, taxonomies, menus, users and site-settings abilities under the webchanges/ namespace.',
...
add_action('admin_bar_menu', static function (\WP_Admin_Bar $wp_admin_bar) {
    $wp_admin_bar->add_node([
        'id' => 'webchanges-ai-connector-mcp-status',
        'title' => esc_html__('Webchanges ON', 'webchanges-ai-connector-mcp'),
        'href' => admin_url('admin.php?page=' . WEBCHANGES_CONNECTOR_SLUG),
        'meta' => ['class' => 'webchanges-ai-connector-mcp-on'],
    ]);
}, 999);
